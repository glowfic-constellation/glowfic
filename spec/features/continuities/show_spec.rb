...
RSpec.feature "Show a single continuity", :type => :feature do
  scenario "View a standard continuity" do
    ...
    create_list(:post, 5, continuity: continuity, user: continuity.creator)
  ...
  scenario "View a continuity with deleted users" do
    ...
    continuity = create(:continuity, name: "Test continuity")
    post1 = create(:post, user: del_user1, continuity: continuity)
    create(:reply, post: post1, user: coauthor3)
    post2 = create(:post, user: del_user2, continuity: continuity)
    post3 = create(:post, user: del_user2, continuity: continuity, authors: [del_user1, del_user2, coauthor1, coauthor2, coauthor3])
    create(:reply, post: post3, user: coauthor2)
    post4 = create(:post, user: coauthor1, continuity: continuity, authors: [del_user2, coauthor1, coauthor3])
