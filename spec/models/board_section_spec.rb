RSpec.describe BoardSection do
  ...
  it "should reset section_* fields in posts after deletion" do
    board = create(:board)
    BoardSection.create!(continuity: board, name: 'Test')
    section = BoardSection.create!(continuity: board, name: 'Test')
    section2 = BoardSection.create!(continuity: board, name: 'Test')
    post = create(:post, continuity: board, section_id: section.id)
  ...
  it "should autofill post section order when not specified" do
    board = create(:board)
    section = BoardSection.create!(continuity: board, name: 'Test')
    post0 = create(:post, continuity: board, section_id: section.id)
  ...
  it "should autofill board section order when not specified" do
    board = create(:board)
    section0 = create(:board_section, continuity: board)
  ...
  it "should reorder upon deletion" do
    ...
    section2 = create(:board_section, continuity: board)
    expect(section2.section_order).to eq(2)
    section3 = create(:board_section, continuity: board)
  ...
  it "should reorder upon board change" do
    ...
    section3 = create(:board_section, continuity: board)
    expect(section3.section_order).to eq(3)
    section1.update!(continuity: create(:board))
    expect(section0.reload.section_order).to eq(0)
    expect(section2.reload.section_order).to eq(1)
    expect(section3.reload.section_order).to eq(2)
  end
