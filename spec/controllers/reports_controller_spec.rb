RSpec.describe ReportsController do
  ...
  describe "GET show" do
    ...
    it "sorts by continuity" do
      ...
      post1 = Timecop.freeze(today) { create(:post, board: continuity1) }
      post2 = Timecop.freeze(today + 2.hours) { create(:post, board: continuity1) }
      post3 = Timecop.freeze(today) { create(:post, board: continuity2) }
      post4 = Timecop.freeze(today + 1.hour) { create(:post, board: continuity2) }
      user = create(:user, timezone: 'UTC')
      login_as(user)
