RSpec.describe RepliesController, 'GET show' do
  ...
  it "calculates OpenGraph meta" do
    ...
    section = create(:board_section, continuity: board, name: 'example section')
    post = create(:post, continuity: board, section: section, user: user, subject: 'a post', description: 'Test.')
