RSpec.describe Api::V1::BoardSectionsController do
  describe "POST reorder" do
    ...
    it "requires a single board" do
      ...
      board_section1 = create(:board_section, board: board1)
      board_section2 = create(:board_section, board: board2)
      board_section3 = create(:board_section, board: board2)
    ...
    it "works for valid changes", :show_in_doc do
      ...
      board_section1 = create(:board_section, board: board)
      board_section2 = create(:board_section, board: board)
      board_section3 = create(:board_section, board: board)
      board_section4 = create(:board_section, board: board)
      board_section5 = create(:board_section, board: board2)
