class PostImporter < Object
  ...
  def import(continuity_id, importer_id, section_id: nil, status: Post::STATUS_COMPLETE, threaded: false)
    validate_url!
  ...
  def validate_duplicate!(continuity_id)
    ...
    subj_post = Post.where(subject: subject, continuity_id: continuity_id).first
