...
class MessagesController < ApplicationController
  ...
  def new
    ...
    @message.recipient = recipient if recipient&.has_interaction_blocked?(current_user)
  ...
  def editor_setup
    ...
    unless @message.try(:parent)
      ...
      base_users = User.where.not(id: [current_user.id] + current_user.blocked_interaction_user_ids(reciever_direction: 'blocking'))
