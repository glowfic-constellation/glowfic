  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::BoardSection).void)
      ).returns(T.nilable(T::Enumerator[::BoardSection]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::BoardSection]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::BoardSection]]))
    end
