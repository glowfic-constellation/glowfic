  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::ReplyDraft).void)
      ).returns(T.nilable(T::Enumerator[::ReplyDraft]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::ReplyDraft]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::ReplyDraft]]))
    end
