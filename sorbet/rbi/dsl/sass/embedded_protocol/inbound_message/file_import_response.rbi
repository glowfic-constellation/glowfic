...
class Sass::EmbeddedProtocol::InboundMessage::FileImportResponse
  sig { params(error: T.nilable(String), file_url: T.nilable(String), id: T.nilable(Integer)).void }
  def initialize(error: nil, file_url: nil, id: nil); end
