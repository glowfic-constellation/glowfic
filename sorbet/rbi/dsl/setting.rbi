...
class Setting
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(T::Array[T.untyped]) }
    def child_setting_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def child_setting_ids=(ids); end

    sig { returns(T::Array[T.untyped]) }
    def child_setting_tag_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def child_setting_tag_ids=(ids); end

    # This method is created by ActiveRecord on the `Setting` class because it declared `has_many :child_setting_tags`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Tag::SettingTag::PrivateCollectionProxy) }
    def child_setting_tags; end

    sig { params(value: T::Enumerable[::Tag::SettingTag]).void }
    def child_setting_tags=(value); end

    # This method is created by ActiveRecord on the `Setting` class because it declared `has_many :child_settings, through: :parent_setting_tags`.
    # 🔗 [Rails guide for `has_many_through` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-through-association)
    sig { returns(::Setting::PrivateCollectionProxy) }
    def child_settings; end

    sig { params(value: T::Enumerable[::Setting]).void }
    def child_settings=(value); end
    ...
    sig { returns(T::Array[T.untyped]) }
    def parent_setting_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def parent_setting_ids=(ids); end

    sig { returns(T::Array[T.untyped]) }
    def parent_setting_tag_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def parent_setting_tag_ids=(ids); end

    # This method is created by ActiveRecord on the `Setting` class because it declared `has_many :parent_setting_tags`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Tag::SettingTag::PrivateCollectionProxy) }
    def parent_setting_tags; end

    sig { params(value: T::Enumerable[::Tag::SettingTag]).void }
    def parent_setting_tags=(value); end

    # This method is created by ActiveRecord on the `Setting` class because it declared `has_many :parent_settings, through: :child_setting_tags`.
    # 🔗 [Rails guide for `has_many_through` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-through-association)
    sig { returns(::Setting::PrivateCollectionProxy) }
    def parent_settings; end

    sig { params(value: T::Enumerable[::Setting]).void }
    def parent_settings=(value); end
