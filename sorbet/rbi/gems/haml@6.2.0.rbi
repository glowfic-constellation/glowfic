...
module Haml::AttributeBuilder
  class << self
    # source://haml/lib/haml/attribute_builder.rb#13
    def build(escape_attrs, quote, format, boolean_attributes, object_ref, *hashes); end

    # source://haml/lib/haml/attribute_builder.rb#74
    def build_aria(escape_attrs, quote, *hashes); end

    # source://haml/lib/haml/attribute_builder.rb#40
    def build_class(escape_attrs, *values); end

    # source://haml/lib/haml/attribute_builder.rb#70
    def build_data(escape_attrs, quote, *hashes); end

    # source://haml/lib/haml/attribute_builder.rb#36
    def build_id(escape_attrs, *values); end

    private

    # source://haml/lib/haml/attribute_builder.rb#143
    def build_boolean!(escape_attrs, quote, format, buf, key, value); end

    # source://haml/lib/haml/attribute_builder.rb#80
    def build_data_attribute(key, escape_attrs, quote, *hashes); end

    # source://haml/lib/haml/attribute_builder.rb#159
    def escape_html(escape_attrs, str); end

    # source://haml/lib/haml/attribute_builder.rb#102
    def flatten_attributes(attributes); end

    # source://haml/lib/haml/attribute_builder.rb#123
...
class Haml::EscapeAny < ::Haml::Escape
  ...
  # source://temple/0.10.2lib/temple/filters/escapable.rb#24
...
module Haml::Util
  ...
  # source://haml_lint/0.51.0lib/haml_lint/extensions/haml_util_unescape_interpolation_tracking.rb#27
  ...
  class << self
    ...
    # source://haml_lint/0.51.0lib/haml_lint/extensions/haml_util_unescape_interpolation_tracking.rb#13
    def unescape_interpolation_to_original_cache; end

    # source://haml_lint/0.51.0lib/haml_lint/extensions/haml_util_unescape_interpolation_tracking.rb#19
