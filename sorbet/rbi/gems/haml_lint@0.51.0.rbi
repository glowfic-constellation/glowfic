...
module Haml::Util
  # source://haml/6.2.0lib/haml/util.rb#172
  def balance(scanner, start, finish, count = T.unsafe(nil)); end

  # source://haml/6.2.0lib/haml/util.rb#66
  def check_encoding(str); end

  # source://haml/6.2.0lib/haml/util.rb#113
  def check_haml_encoding(str, &block); end

  # source://haml/6.2.0lib/haml/util.rb#201
  def contains_interpolation?(str); end

  # source://haml/6.2.0lib/haml/util.rb#151
  def handle_interpolation(str); end

  # source://haml/6.2.0lib/haml/util.rb#188
  def human_indentation(indentation); end

  # source://haml/6.2.0lib/haml/util.rb#130
  def inspect_obj(obj); end

  # source://haml/6.2.0lib/haml/util.rb#52
  def rails_xss_safe?; end

  # source://haml/6.2.0lib/haml/util.rb#38
...
class HamlLint::ParsedRuby < ::SimpleDelegator
  ...
  #
  # source://delegate/0.3.0delegate.rb#318
  def syntax_tree; end
end
