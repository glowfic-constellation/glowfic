...
class ActionDispatch::Journey::Route
  ...
  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#56
  ...
  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#7
  def app; end
  ...
  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#142
  def dispatcher?; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#78
  def eager_load!; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#120
  def format(path_options); end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#138
  def glob?; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#7
  def internal; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#164
  def ip; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#146
  def matches?(request); end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#7
  def name; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#115
  def parts; end
  ...
  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#128
  def required_default?(key); end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#132
  def required_defaults; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#103
  def required_keys; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#124
  def required_parts; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#93
  def requirements; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#168
  def requires_matching_verb?; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#7
  def scope_options; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#107
  def score(supplied_keys); end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#115
  def segment_keys; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#99
  def segments; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#7
  def source_location; end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#172
  def verb; end

  private

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#181
  def match_verb(request); end

  # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#177
  def verbs; end

  class << self
    # source://actionpack/7.1.3.4/lib/action_dispatch/journey/route.rb#47
...
module Apipie::DSL::Common
  ...
  # source://apipie-rails//lib/apipie/dsl_definition.rb#307
  def _apipie_get_method_params(method); end

  # source://apipie-rails//lib/apipie/dsl_definition.rb#292
  def _apipie_handle_validate_key_error(params, param); end

  # source://apipie-rails//lib/apipie/dsl_definition.rb#302
  ...
  #   end
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#320
...
# source://apipie-rails//lib/apipie/dsl_definition.rb#563
module Apipie::DSL::Concern
  ...
  # source://apipie-rails//lib/apipie/dsl_definition.rb#582
  def _apipie_concern_data; end

  # source://apipie-rails//lib/apipie/dsl_definition.rb#586
  def _apipie_concern_update_api_blocks; end

  # @return [Boolean]
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#590
  def apipie_concern?; end

  # the concern was included into a controller
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#570
  def included(controller); end

  # create method api and redefine newly added method
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#595
  def method_added(method_name); end

  # source://apipie-rails//lib/apipie/dsl_definition.rb#605
  def update_api(*methods, &block); end
end

# source://apipie-rails//lib/apipie/dsl_definition.rb#449
module Apipie::DSL::Controller
  ...
  # source://apipie-rails//lib/apipie/dsl_definition.rb#528
  def _apipie_concern_subst; end

  # source://apipie-rails//lib/apipie/dsl_definition.rb#535
  def _apipie_perform_concern_subst(string); end

  # source://apipie-rails//lib/apipie/dsl_definition.rb#507
  ...
  #      end
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#500
  def _apipie_update_params(method_desc, dsl_data); end

  # @return [Boolean]
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#541
  def apipie_concern?; end
  ...
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#479
  def apipie_concern_subst(subst_hash); end

  # source://apipie-rails//lib/apipie/dsl_definition.rb#514
  ...
  # create method api and redefine newly added method
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#546
  def method_added(method_name); end
end
...
#
# source://apipie-rails//lib/apipie/dsl_definition.rb#333
module Apipie::DSL::Param
  # where the group definition should be looked up when no scope
  # given. This is expected to return a controller.
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#444
  ...
  #   end
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#342
  ...
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#363
  def param_group(name, scope_or_options = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://apipie-rails//lib/apipie/dsl_definition.rb#351
  ...
  #   end
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#403
...
# source://apipie-rails//lib/apipie/dsl_definition.rb#611
class Apipie::DSL::ResourceDescriptionDsl
  ...
  #
  # source://apipie-rails//lib/apipie/dsl_definition.rb#617
  def initialize(controller); end

  class << self
    # evaluates resource description DSL and returns results
    #
    # source://apipie-rails//lib/apipie/dsl_definition.rb#622
...
class Apipie::FileHandler
  ...
  # source://apipie-rails//lib/apipie/static_dispatcher.rb#44
  def cache_extension; end

  # source://apipie-rails//lib/apipie/static_dispatcher.rb#33
  def call(env); end

  # source://apipie-rails//lib/apipie/static_dispatcher.rb#37
  def ext; end
...
class Apipie::ResponseDescription
  ...
  # source://apipie-rails//lib/apipie/response_description.rb#134
  def additional_properties; end
  ...
  # @return [Array<Hash>]
  #
  # source://apipie-rails//lib/apipie/response_description.rb#140
  def headers; end
  ...
  # source://apipie-rails//lib/apipie/response_description.rb#126
  ...
  #
  # source://apipie-rails//lib/apipie/response_description.rb#150
  def to_json(lang = T.unsafe(nil)); end
...
# source://apipie-rails//lib/apipie/static_dispatcher.rb#54
class Apipie::StaticDispatcher
  ...
  #
  # source://apipie-rails//lib/apipie/static_dispatcher.rb#57
  def initialize(app, path); end

  # source://apipie-rails//lib/apipie/static_dispatcher.rb#62
  def call(env); end
end
