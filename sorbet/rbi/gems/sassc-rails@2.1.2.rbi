...
module SassC
  class << self
    # source://sassc/2.4.0lib/sassc.rb#21
    def load_paths; end
  end
end
...
class Sprockets::SassCompressor
  ...
  # source://sprockets/4.2.1lib/sprockets/sass_compressor.rb#37
  def cache_key; end
  ...
  class << self
    # source://sprockets/4.2.1lib/sprockets/sass_compressor.rb#33
    def cache_key; end

    # source://sprockets/4.2.1lib/sprockets/sass_compressor.rb#29
    def call(input); end

    # source://sprockets/4.2.1lib/sprockets/sass_compressor.rb#25
    def instance; end
  end
end
