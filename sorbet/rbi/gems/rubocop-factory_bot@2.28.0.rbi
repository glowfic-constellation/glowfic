...
class RuboCop::Cop::FactoryBot::AssociationStyle < ::RuboCop::Cop::Base
  ...
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#89
  ...
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#137
  def trait_name(param0); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#127
  def trait_names_from_explicit(param0 = T.unsafe(nil)); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#94
  def with_strategy_build_option?(param0 = T.unsafe(nil)); end

  private

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#141
  ...
  # @return [Boolean]
  #
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#167
  def bad?(node); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#190
  ...
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#208
  def factory_names_from_explicit(node); end

  # @return [Boolean]
  #
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#180
  def keyword?(node); end

  # @return [Boolean]
  #
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#218
  def non_implicit_association_method_name?(method_name); end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#222
  def non_implicit_association_method_names; end

  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#235
  ...
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#248
  def trait_factory_node(node); end

  # @return [Boolean]
  #
  # source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#244
  def trait_within_trait?(node, factory_node); end
end

# source://rubocop-factory_bot//lib/rubocop/cop/factory_bot/association_style.rb#69
