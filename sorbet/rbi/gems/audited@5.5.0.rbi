...
module Audited
  class << self
    # source://audited//lib/audited.rb#17
    def audit_class; end
    ...
    #
    # source://audited//lib/audited.rb#15
...
# source://audited//lib/audited/auditor.rb#426
module Audited::Auditor::AuditedClassMethods
  ...
  # @see Audit#as_user.
  #
  # source://audited//lib/audited/auditor.rb#482
  def audit_as(user, &block); end

  # Returns an array of columns that are audited. See non_audited_columns
  #
  # source://audited//lib/audited/auditor.rb#428
  def audited_columns; end

  # source://audited//lib/audited/auditor.rb#486
  def auditing_enabled; end

  # source://audited//lib/audited/auditor.rb#490
  def auditing_enabled=(val); end

  # source://audited//lib/audited/auditor.rb#494
  def default_ignored_attributes; end

  # source://audited//lib/audited/auditor.rb#470
  def disable_auditing; end

  # source://audited//lib/audited/auditor.rb#474
  ...
  # source://audited//lib/audited/auditor.rb#437
  ...
  #   end
  #
  # source://audited//lib/audited/auditor.rb#462
  ...
  #   end
  #
  # source://audited//lib/audited/auditor.rb#448
  def without_auditing; end

  protected

  # source://audited//lib/audited/auditor.rb#509
  def calculate_non_audited_columns; end

  # source://audited//lib/audited/auditor.rb#519
  def class_auditing_enabled; end

  # source://audited//lib/audited/auditor.rb#500
...
module Audited::Auditor::AuditedInstanceMethods
  ...
  # source://audited//lib/audited/auditor.rb#352
  def audit_destroy; end

  # source://audited//lib/audited/auditor.rb#352
  def audit_destroy_callback; end

  # source://audited//lib/audited/auditor.rb#345
  def audit_touch; end

  # source://audited//lib/audited/auditor.rb#338
  ...
  # source://audited//lib/audited/auditor.rb#405
  def auditing_enabled; end

  # source://audited//lib/audited/auditor.rb#321
  def audits_to(version = T.unsafe(nil)); end

  # source://audited//lib/audited/auditor.rb#386
  def combine_audits_if_needed; end

  # @return [Boolean]
  #
  # source://audited//lib/audited/auditor.rb#379
  ...
  #
  # source://audited//lib/audited/auditor.rb#304
  def filter_attr_values(audited_changes: T.unsafe(nil), attrs: T.unsafe(nil), placeholder: T.unsafe(nil)); end

  # source://audited//lib/audited/auditor.rb#292
  def filter_encrypted_attrs(filtered_changes); end

  # source://audited//lib/audited/auditor.rb#266
  def normalize_enum_changes(changes); end

  # source://audited//lib/audited/auditor.rb#373
  def presence_of_audit_comment; end

  # @return [Boolean]
  #
  # source://audited//lib/audited/auditor.rb#317
  def rails_below?(rails_version); end

  # source://audited//lib/audited/auditor.rb#419
  def reconstruct_attributes(audits); end

  # source://audited//lib/audited/auditor.rb#284
  def redact_values(filtered_changes); end

  # source://audited//lib/audited/auditor.rb#394
  ...
  # source://audited//lib/audited/auditor.rb#359
