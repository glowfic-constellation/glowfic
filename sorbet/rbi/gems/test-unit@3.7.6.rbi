...
class Test::Unit::AutoRunner
  ...
  #
  # source://test-unit//lib/test/unit/autorunner.rb#154
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/autorunner.rb#188
  def debug_on_failure?; end
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#470
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#192
  def prepare; end

  # source://test-unit//lib/test/unit/autorunner.rb#198
  def process_args(args = T.unsafe(nil)); end

  # source://test-unit//lib/test/unit/autorunner.rb#488
  def run; end
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/autorunner.rb#184
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#559
  ...
  # source://test-unit//lib/test/unit/autorunner.rb#578
  def prepare_name(name); end

  class << self
    # source://test-unit//lib/test/unit/autorunner.rb#46
    def collector(id); end

    # source://test-unit//lib/test/unit/autorunner.rb#32
    def default_runner; end

    # source://test-unit//lib/test/unit/autorunner.rb#36
    def default_runner=(id); end

    # source://test-unit//lib/test/unit/autorunner.rb#85
    def need_auto_run=(need); end

    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/autorunner.rb#81
    def need_auto_run?; end

    # source://test-unit//lib/test/unit/autorunner.rb#59
    def prepare(hook = T.unsafe(nil), &block); end

    # source://test-unit//lib/test/unit/autorunner.rb#40
    def register_collector(id, collector_builder = T.unsafe(nil), &block); end

    # source://test-unit//lib/test/unit/autorunner.rb#50
    def register_color_scheme(id, scheme); end

    # source://test-unit//lib/test/unit/autorunner.rb#21
    def register_runner(id, runner_builder = T.unsafe(nil), &block); end

    # source://test-unit//lib/test/unit/autorunner.rb#64
    def run(force_standalone = T.unsafe(nil), default_dir = T.unsafe(nil), argv = T.unsafe(nil), &block); end

    # source://test-unit//lib/test/unit/autorunner.rb#27
    def runner(id); end

    # source://test-unit//lib/test/unit/autorunner.rb#54
    def setup_option(option_builder = T.unsafe(nil), &block); end

    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/autorunner.rb#72
    def standalone?; end
  end
end
...
# source://test-unit//lib/test/unit/autorunner.rb#636
class Test::Unit::AutoRunner::GCStressListener
  # source://test-unit//lib/test/unit/autorunner.rb#637
...
# source://test-unit//lib/test/unit/autorunner.rb#628
class Test::Unit::AutoRunner::StopOnFailureListener
  # source://test-unit//lib/test/unit/autorunner.rb#629
  def attach_to_mediator(mediator); end
end
...
# source://test-unit//lib/test/unit/process-test-result.rb#9
class Test::Unit::ProcessTestResult
  # @return [ProcessTestResult] a new instance of ProcessTestResult
  #
  # source://test-unit//lib/test/unit/process-test-result.rb#10
  def initialize(output); end

  # Records an individual assertion.
  #
  # source://test-unit//lib/test/unit/process-test-result.rb#23
  def add_assertion; end

  # source://test-unit//lib/test/unit/process-test-result.rb#27
  def add_error(error); end

  # source://test-unit//lib/test/unit/process-test-result.rb#31
  def add_failure(failure); end

  # source://test-unit//lib/test/unit/process-test-result.rb#43
  def add_notification(notification); end

  # source://test-unit//lib/test/unit/process-test-result.rb#39
  def add_omission(omission); end

  # source://test-unit//lib/test/unit/process-test-result.rb#18
  def add_pass; end

  # source://test-unit//lib/test/unit/process-test-result.rb#35
  def add_pending(pending); end

  # source://test-unit//lib/test/unit/process-test-result.rb#14
  def add_run; end

  private

  # source://test-unit//lib/test/unit/process-test-result.rb#49
  def send_result(action, *args); end
end
...
class Test::Unit::TestCase
  ...
  class << self
    ...
    # source://test-unit//lib/test/unit/testcase.rb#475
    ...
    #   case class context.
    #
    # source://test-unit//lib/test/unit/testcase.rb#455
    ...
    # @return [Boolean]
    #
    # source://test-unit//lib/test/unit/testcase.rb#470
    ...
    # source://test-unit//lib/test/unit/testcase.rb#518
    def worker_id=(worker_id); end
    ...
    # @private
    #
    # source://test-unit//lib/test/unit/testcase.rb#529
    def method_locations; end

    # @private
    #
    # source://test-unit//lib/test/unit/testcase.rb#565
    def sub_test_case_class(name); end

    # @private
    #
    # source://test-unit//lib/test/unit/testcase.rb#541
...
# source://test-unit//lib/test/unit/testcase.rb#989
class Test::Unit::TestCase::InternalData
  # @return [InternalData] a new instance of InternalData
  #
  # source://test-unit//lib/test/unit/testcase.rb#994
  def initialize; end

  # source://test-unit//lib/test/unit/testcase.rb#1013
  def assign_test_data(label, data); end

  # Returns the value of attribute elapsed_time.
  #
  # source://test-unit//lib/test/unit/testcase.rb#990
  def elapsed_time; end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/testcase.rb#1018
  def have_test_data?; end

  # source://test-unit//lib/test/unit/testcase.rb#1034
  def interrupted; end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/testcase.rb#1009
  def interrupted?; end

  # source://test-unit//lib/test/unit/testcase.rb#1038
  def marshal_dump; end

  # source://test-unit//lib/test/unit/testcase.rb#1048
  def marshal_load(data); end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/testcase.rb#1005
  def passed?; end

  # source://test-unit//lib/test/unit/testcase.rb#1030
  def problem_occurred; end

  # Returns the value of attribute run_context.
  #
  # source://test-unit//lib/test/unit/testcase.rb#992
  def run_context; end
  ...
  #
  # source://test-unit//lib/test/unit/testcase.rb#991
  def test_data; end
  ...
  # source://test-unit//lib/test/unit/testcase.rb#1026
  def test_finished; end

  # source://test-unit//lib/test/unit/testcase.rb#1022
  def test_started; end

  # Returns the value of attribute worker_id.
  #
  # source://test-unit//lib/test/unit/testcase.rb#993
  def worker_id; end

  # Sets the attribute worker_id
  #
  # @param value the value to set the attribute worker_id to.
  #
  # source://test-unit//lib/test/unit/testcase.rb#993
...
# source://test-unit//lib/test/unit/test-process-run-context.rb#11
class Test::Unit::TestProcessRunContext < ::Test::Unit::TestRunContext
  # @return [TestProcessRunContext] a new instance of TestProcessRunContext
  #
  # source://test-unit//lib/test/unit/test-process-run-context.rb#14
  def initialize(runner_class); end

  # Returns the value of attribute progress_block.
  #
  # source://test-unit//lib/test/unit/test-process-run-context.rb#13
  def progress_block; end

  # Sets the attribute progress_block
  #
  # @param value the value to set the attribute progress_block to.
  #
  # source://test-unit//lib/test/unit/test-process-run-context.rb#13
  def progress_block=(_arg0); end

  # Returns the value of attribute test_names.
  #
  # source://test-unit//lib/test/unit/test-process-run-context.rb#12
  def test_names; end
end
...
class Test::Unit::TestSuite
  ...
  #
  # source://test-unit//lib/test/unit/testsuite.rb#122
  def ==(other); end

  # source://test-unit//lib/test/unit/testsuite.rb#94
  def delete(test); end

  # source://test-unit//lib/test/unit/testsuite.rb#98
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/testsuite.rb#61
  def have_fixture?; end
  ...
  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/testsuite.rb#56
  def parallel_safe?; end

  # @return [Boolean]
  #
  # source://test-unit//lib/test/unit/testsuite.rb#128
  def passed?; end
  ...
  # TestSuite.
  #
  # source://test-unit//lib/test/unit/testsuite.rb#70
  def run(worker_context, &progress_block); end

  # Returns the rolled up number of tests in this suite;
  # i.e. if the suite contains other suites, it counts the
  # tests within those suites, not the suites themselves.
  #
  # source://test-unit//lib/test/unit/testsuite.rb#105
  def size; end
  ...
  # creation.
  #
  # source://test-unit//lib/test/unit/testsuite.rb#117
  def to_s; end
end
...
# source://test-unit//lib/test/unit/test-suite-process-runner.rb#16
class Test::Unit::TestSuiteProcessRunner < ::Test::Unit::TestSuiteRunner
  # source://test-unit//lib/test/unit/test-suite-process-runner.rb#175
  def run(worker_context, &progress_block); end

  private

  # source://test-unit//lib/test/unit/test-suite-process-runner.rb#181
  def run_tests_recursive(test_suite, worker_context, &progress_block); end

  class << self
    # source://test-unit//lib/test/unit/test-suite-process-runner.rb#51
    def run_all_tests(result, options); end

    private

    # source://test-unit//lib/test/unit/test-suite-process-runner.rb#162
    def add_result(result, data); end

    # source://test-unit//lib/test/unit/test-suite-process-runner.rb#168
    def emit_event(event_listener, data); end

    # source://test-unit//lib/test/unit/test-suite-process-runner.rb#151
    def select_each_worker(worker_inputs, workers); end

    # source://test-unit//lib/test/unit/test-suite-process-runner.rb#141
    def start_tcp_server; end
  end
end

# source://test-unit//lib/test/unit/test-suite-process-runner.rb#17
Test::Unit::TestSuiteProcessRunner::MAIN_TO_WORKER_INPUT_FILENO = T.let(T.unsafe(nil), Integer)

# source://test-unit//lib/test/unit/test-suite-process-runner.rb#18
Test::Unit::TestSuiteProcessRunner::WORKER_TO_MAIN_OUTPUT_FILENO = T.let(T.unsafe(nil), Integer)
...
class Test::Unit::TestSuiteRunner
  ...
  # source://test-unit//lib/test/unit/test-suite-runner.rb#120
  def handle_exception(exception, result); end

  # source://test-unit//lib/test/unit/test-suite-runner.rb#109
  def run_shutdown(worker_context); end

  # source://test-unit//lib/test/unit/test-suite-runner.rb#50
  def run_startup(worker_context); end

  # source://test-unit//lib/test/unit/test-suite-runner.rb#67
  def run_test(test, worker_context); end

  # source://test-unit//lib/test/unit/test-suite-runner.rb#61
  def run_tests(worker_context, &progress_block); end
...
class Test::Unit::TestSuiteThreadRunner < ::Test::Unit::TestSuiteRunner
  # source://test-unit//lib/test/unit/test-suite-thread-runner.rb#57
  def run(worker_context, &progress_block); end

  private

  # source://test-unit//lib/test/unit/test-suite-thread-runner.rb#63
  def run_tests_recursive(test_suite, worker_context, &progress_block); end
...
class Test::Unit::TestThreadRunContext < ::Test::Unit::TestRunContext
  ...
  #
  # source://test-unit//lib/test/unit/test-thread-run-context.rb#15
  def initialize(runner_class, queue); end

  # Returns the value of attribute parallel_unsafe_tests.
  #
  # source://test-unit//lib/test/unit/test-thread-run-context.rb#14
  def parallel_unsafe_tests; end

  # Sets the attribute parallel_unsafe_tests
  #
  # @param value the value to set the attribute parallel_unsafe_tests to.
  #
  # source://test-unit//lib/test/unit/test-thread-run-context.rb#14
  def parallel_unsafe_tests=(_arg0); end
