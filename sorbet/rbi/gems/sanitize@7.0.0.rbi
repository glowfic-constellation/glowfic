...
class Sanitize::CSS
  ...
  #
  # source://sanitize//lib/sanitize/css.rb#78
  def initialize(config = T.unsafe(nil)); end

  # Returns the value of attribute config.
  #
  # source://sanitize//lib/sanitize/css.rb#8
  def config; end
  ...
  #
  # source://sanitize//lib/sanitize/css.rb#98
  ...
  #
  # source://sanitize//lib/sanitize/css.rb#129
  ...
  #
  # source://sanitize//lib/sanitize/css.rb#159
  def tree!(tree); end
  ...
  #
  # source://sanitize//lib/sanitize/css.rb#207
  ...
  # @return [Boolean]
  #
  # source://sanitize//lib/sanitize/css.rb#236
  ...
  # @return [Boolean]
  #
  # source://sanitize//lib/sanitize/css.rb#242
  ...
  #
  # source://sanitize//lib/sanitize/css.rb#255
  ...
  # @return [Boolean]
  #
  # source://sanitize//lib/sanitize/css.rb#313
  ...
  class << self
    ...
    # @return [String] Sanitized CSS properties.
    #
    # source://sanitize//lib/sanitize/css.rb#22
    ...
    # @return [String] Sanitized CSS stylesheet.
    #
    # source://sanitize//lib/sanitize/css.rb#47
    ...
    # @return [Array] Sanitized Crass CSS parse tree.
    #
    # source://sanitize//lib/sanitize/css.rb#70
...
module Sanitize::Config
  class << self
    ...
    #
    # source://sanitize//lib/sanitize/config.rb#8
    ...
    # @raise [ArgumentError]
    #
    # source://sanitize//lib/sanitize/config.rb#23
    ...
    # @return [Boolean]
    #
    # source://sanitize//lib/sanitize/config.rb#53
...
# source://sanitize//lib/sanitize/transformers/clean_cdata.rb#4
...
#
# source://sanitize//lib/sanitize/transformers/clean_css.rb#7
class Sanitize::Transformers::CSS::CleanAttribute
  # @return [CleanAttribute] a new instance of CleanAttribute
  #
  # source://sanitize//lib/sanitize/transformers/clean_css.rb#8
  def initialize(sanitizer_or_config); end

  # source://sanitize//lib/sanitize/transformers/clean_css.rb#16
  def call(env); end
end

# Enforces a CSS allowlist on the contents of `<style>` elements.
#
# source://sanitize//lib/sanitize/transformers/clean_css.rb#34
class Sanitize::Transformers::CSS::CleanElement
  # @return [CleanElement] a new instance of CleanElement
  #
  # source://sanitize//lib/sanitize/transformers/clean_css.rb#35
  def initialize(sanitizer_or_config); end

  # source://sanitize//lib/sanitize/transformers/clean_css.rb#43
  def call(env); end
end
...
# source://sanitize//lib/sanitize/transformers/clean_element.rb#8
class Sanitize::Transformers::CleanElement
  # @return [CleanElement] a new instance of CleanElement
  #
  # source://sanitize//lib/sanitize/transformers/clean_element.rb#61
  def initialize(config); end

  # source://sanitize//lib/sanitize/transformers/clean_element.rb#92
  def call(env); end
end
...
#
# source://sanitize//lib/sanitize/transformers/clean_element.rb#22
...
#
# source://sanitize//lib/sanitize/transformers/clean_element.rb#25
...
# libxml2 behavior.
#
# source://sanitize//lib/sanitize/transformers/clean_element.rb#38
...
# libxml2 behavior.
#
# source://sanitize//lib/sanitize/transformers/clean_element.rb#44
...
#
# source://sanitize//lib/sanitize/transformers/clean_element.rb#52
