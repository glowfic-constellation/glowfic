...
class ActionDispatch::Journey::Route
  ...
  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#56
  ...
  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#7
  def app; end
  ...
  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#142
  def dispatcher?; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#78
  def eager_load!; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#120
  def format(path_options); end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#138
  def glob?; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#7
  def internal; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#164
  def ip; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#146
  def matches?(request); end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#7
  def name; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#115
  def parts; end
  ...
  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#128
  def required_default?(key); end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#132
  def required_defaults; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#103
  def required_keys; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#124
  def required_parts; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#93
  def requirements; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#168
  def requires_matching_verb?; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#7
  def scope_options; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#107
  def score(supplied_keys); end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#115
  def segment_keys; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#99
  def segments; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#7
  def source_location; end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#172
  def verb; end

  private

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#181
  def match_verb(request); end

  # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#177
  def verbs; end

  class << self
    # source://actionpack/7.1.2/lib/action_dispatch/journey/route.rb#47
