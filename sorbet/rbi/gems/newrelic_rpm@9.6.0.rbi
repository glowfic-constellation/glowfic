...
class NewRelic::Agent::Logging::DecoratingLogger < ::ActiveSupport::Logger
  ...
  # @api public
  #
  # source://logger/1.5.3logger.rb#694
...
class NewRelic::Agent::Tracer
  class << self
    ...
    # @api public
    #
    # source://newrelic_rpm/lib/new_relic/agent/tracer.rb#455
    def log_error(method_name, exception); end

    # @api public
    #
    # source://newrelic_rpm/lib/new_relic/agent/tracer.rb#443
...
class NewRelic::Agent::Tracer::State
  ...
  # @api public
  #
  # source://newrelic_rpm/lib/new_relic/agent/tracer.rb#481
  def current_transaction; end
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm/lib/new_relic/agent/tracer.rb#495
  ...
  # @api public
  #
  # source://newrelic_rpm/lib/new_relic/agent/tracer.rb#502
  def record_sql; end
  ...
  # @api public
  #
  # source://newrelic_rpm/lib/new_relic/agent/tracer.rb#471
  ...
  # @api public
  #
  # source://newrelic_rpm/lib/new_relic/agent/tracer.rb#509
  ...
  # @api public
  #
  # source://newrelic_rpm/lib/new_relic/agent/tracer.rb#484
  def untraced; end
