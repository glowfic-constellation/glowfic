...
module NewRelic::Agent::Configuration
  class << self
    ...
    #
    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#27
    def deprecated_description(new_setting, description); end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#19
    def instrumentation_value_from_boolean(key); end

    # Helper since default Procs are evaluated in the context of this module
    #
    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#13
    def value_of(key); end
  end
end

# source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#287
...
# source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#340
...
class NewRelic::Agent::Configuration::DefaultSource
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#53
  def initialize; end

  # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#51
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#48
  def defaults; end
  ...
  class << self
    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#159
    def agent_enabled; end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#73
    def allowlist_for(key); end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#217
    def api_host; end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#179
    def app_name; end
    ...
    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#91
    ...
    # @raise [ArgumentError]
    #
    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#249
    def convert_to_hash(value); end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#238
    def convert_to_list(value); end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#266
    ...
    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#183
    def dispatcher; end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#135
    def framework; end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#206
    def host; end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#195
    def profiling_available; end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#187
    def thread_profiler_enabled; end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#191
    def transaction_tracer_transaction_threshold; end

    # source://newrelic_rpm//lib/new_relic/agent/configuration/default_source.rb#87
...
module NewRelic::Agent::Datastores
  class << self
    ...
    # @param elapsed [Float] (optional, deprecated)  the elapsed time during
    #   query execution
    ...
    # @param scoped_metric [String] (optional, deprecated) The most specific
    #   metric relating to this query. Typically the result of
    #   NewRelic::Agent::Datastores::MetricHelper#metrics_for
    #
    # source://newrelic_rpm//lib/new_relic/agent/datastores.rb#170
    def notice_sql(query, scoped_metric = T.unsafe(nil), elapsed = T.unsafe(nil)); end
    ...
    #
    # source://newrelic_rpm//lib/new_relic/agent/datastores.rb#207
    def notice_statement(statement, elapsed = T.unsafe(nil)); end
    ...
    #   e.g. "FauxDB"
    #
    # source://newrelic_rpm//lib/new_relic/agent/datastores.rb#111
...
class NewRelic::Agent::OpenTelemetryBridge
  ...
  class << self
    # source://newrelic_rpm//lib/new_relic/agent/opentelemetry_bridge.rb#21
    def install; end
  end
end
...
class NewRelic::Agent::SlowSql
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#245
  ...
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#257
  def base_params; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#280
  def explain; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#271
  def obfuscate; end

  # We can't serialize the explainer, so clear it before we transmit
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#287
...
class NewRelic::Agent::SqlSampler
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#161
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#173
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#212
  def reset!; end
...
class NewRelic::Agent::SqlTrace < ::NewRelic::Agent::Stats
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#301
  def initialize(normalized_query, slow_sql, path, uri); end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#318
  def aggregate(slow_sql, path, uri); end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#326
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#340
  def need_to_explain?; end

  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#336
  ...
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#330
  def prepare_to_send; end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#309
  ...
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#346
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#362
...
class NewRelic::Agent::Transaction
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#539
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#931
  def add_custom_attributes(p); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#935
  def add_log_event(event); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#866
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#769
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#628
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#551
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#686
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#599
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#489
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#564
  def finish; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#485
  def finished?; end
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#715
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#971
  def ignore?; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#975
  def ignore_apdex!; end
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#991
  def ignore_trace?; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#732
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#481
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#736
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#413
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#393
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#460
  def name_frozen?; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#560
  def needs_middleware_summary_metrics?(name); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#532
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#385
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#433
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#884
  def record_apdex_metrics(rollup_metric, transaction_prefix, current_apdex_t); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#812
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#841
  def record_log_events; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#849
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#837
  def record_transaction_event; end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#939
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#363
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#711
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#397
  def set_default_transaction_name(name, category); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#406
  def set_overriding_transaction_name(name, category); end

  # @api public
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#947
  def similar_category?(category); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#464
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#543
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#679
  def synthetics_additional_attributes(&block); end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#765
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#760
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#430
  ...
  # @return [Boolean]
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#590
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#915
  ...
  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#1020
  def agent; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#1004
  def jruby_cpu_time; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#997
  def process_cpu; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#1028
  def sql_sampler; end

  # @api public
  #
  # source://newrelic_rpm//lib/new_relic/agent/transaction.rb#1024
  def transaction_sampler; end
...
module NewRelic::Agent::Transaction::TraceContext
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/trace_context.rb#182
  def set_priority_and_sampled(sampler, ratio, payload); end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/transaction/trace_context.rb#175
...
class NewRelic::Agent::TransactionSqlData
  ...
  #
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#225
  def initialize; end
  ...
  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#229
  def set_transaction_info(uri, guid); end

  # source://newrelic_rpm//lib/new_relic/agent/sql_sampler.rb#234
