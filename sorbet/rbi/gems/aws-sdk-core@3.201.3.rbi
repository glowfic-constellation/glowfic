...
class Aws::SQS::Message
  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#24
  def initialize(*args); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#90
  def attributes; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#61
  def body; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#161
  def change_visibility(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#122
  def client; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#137
  def data; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#145
  def data_loaded?; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#177
  def delete(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#200
  def deprecated_identifiers; end

  # source://aws-sdk-core//lib/aws-sdk-core/deprecations.rb#65
  def identifiers(*args, &block); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#128
  def load; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#55
  def md5_of_body; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#103
  def md5_of_message_attributes; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#115
  def message_attributes; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#49
  def message_id; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#191
  def queue; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#36
  def queue_url; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#41
  ...
  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#210
  def extract_queue_url(args, options); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/message.rb#221
  def extract_receipt_handle(args, options); end
end

class Aws::SQS::Queue
  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#22
  def initialize(*args); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#126
  def add_permission(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#39
  def attributes; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#150
  def change_message_visibility_batch(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#46
  def client; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#71
  def data; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#79
  def data_loaded?; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#883
  def dead_letter_source_queues(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#163
  def delete(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#185
  def delete_messages(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#915
  def deprecated_identifiers; end

  # source://aws-sdk-core//lib/aws-sdk-core/deprecations.rb#65
  def identifiers(*args, &block); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#56
  def load; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#905
  def message(receipt_handle); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#198
  def purge(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#415
  def receive_messages(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#56
  def reload; end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#442
  def remove_permission(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#620
  def send_message(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#663
  def send_messages(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#868
  def set_attributes(options = T.unsafe(nil)); end

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#33
  def url; end

  private

  # source://aws-sdk-sqs/1.80.0/lib/aws-sdk-sqs/queue.rb#922
