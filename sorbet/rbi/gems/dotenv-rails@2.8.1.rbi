...
module Dotenv
  ...
  # source://dotenv/2.8.1lib/dotenv.rb#82
  def ignoring_nonexistent_files; end

  # source://dotenv/2.8.1lib/dotenv.rb#68
  def instrument(name, payload = T.unsafe(nil), &block); end

  # source://dotenv/2.8.1lib/dotenv.rb#13
  def load(*filenames); end

  # source://dotenv/2.8.1lib/dotenv.rb#23
  def load!(*filenames); end

  # source://dotenv/2.8.1lib/dotenv.rb#31
  def overload(*filenames); end

  # source://dotenv/2.8.1lib/dotenv.rb#41
  def overload!(*filenames); end

  # source://dotenv/2.8.1lib/dotenv.rb#49
  def parse(*filenames); end

  # source://dotenv/2.8.1lib/dotenv.rb#76
  def require_keys(*keys); end

  # source://dotenv/2.8.1lib/dotenv.rb#60
  ...
  class << self
    ...
    # source://dotenv/2.8.1lib/dotenv.rb#8
