...
module Haml::Util
  # source://haml/6.3.0/lib/haml/util.rb#172
  def balance(scanner, start, finish, count = T.unsafe(nil)); end

  # source://haml/6.3.0/lib/haml/util.rb#66
  def check_encoding(str); end

  # source://haml/6.3.0/lib/haml/util.rb#113
  def check_haml_encoding(str, &block); end

  # source://haml/6.3.0/lib/haml/util.rb#201
  def contains_interpolation?(str); end

  # source://haml/6.3.0/lib/haml/util.rb#151
  def handle_interpolation(str); end

  # source://haml/6.3.0/lib/haml/util.rb#188
  def human_indentation(indentation); end

  # source://haml/6.3.0/lib/haml/util.rb#130
  def inspect_obj(obj); end

  # source://haml/6.3.0/lib/haml/util.rb#52
  def rails_xss_safe?; end

  # source://haml/6.3.0/lib/haml/util.rb#38
...
class HamlLint::Document
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#44
  ...
  # @param source [String] Haml code to parse
  #
  # source://haml_lint//lib/haml_lint/document.rb#68
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#55
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#35
  def unescape_interpolation_to_original_cache; end

  # source://haml_lint//lib/haml_lint/document.rb#85
  ...
  # source://haml_lint//lib/haml_lint/document.rb#200
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#153
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#172
  ...
  # @return [Haml::Tree::Node]
  #
  # source://haml_lint//lib/haml_lint/document.rb#134
  ...
  # source://haml_lint//lib/haml_lint/document.rb#207
...
#
# source://haml_lint//lib/haml_lint/runner.rb#8
class HamlLint::Runner
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#22
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#119
  ...
  # @param config [HamlLint::Configuration]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#87
  ...
  # @return [HamlLint::Configuration]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#40
  def config; end
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#138
  ...
  # @return [true, false]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#45
  def fail_fast; end
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#61
  ...
  # @return [HamlLint::Configuration]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#68
  ...
  # @return [void]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#168
  ...
  # @return [void]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#156
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#179
  ...
  # @return [Array<HamlLint::Source>]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#56
  def sources; end
  ...
  # @return [void]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#190
  def warm_cache; end
end
