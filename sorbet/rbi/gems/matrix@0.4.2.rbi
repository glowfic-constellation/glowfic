...
class Matrix
  ...
  #   #        1   2  3
  #
  # source://matrix//lib/matrix.rb#1586
  def conj; end
  ...
  # @raise [ErrDimensionMismatch]
  #
  # source://matrix//lib/matrix.rb#1355
  def det; end

  # deprecated; use Matrix#determinant
  #
  # source://matrix//lib/matrix.rb#1402
  def det_e; end
  ...
  #
  # source://matrix//lib/matrix.rb#1553
  def eigen; end
  ...
  #   #        0  0  0
  #
  # source://matrix//lib/matrix.rb#1611
  def imag; end
  ...
  #   a.lup.solve([2, 5]) # => Vector[(1/1), (1/2)]
  #
  # source://matrix//lib/matrix.rb#1568
  ...
  #   m.rect == [m.real, m.imag]  # ==> true for all matrices m
  #
  # source://matrix//lib/matrix.rb#1635
  def rectangular; end
  ...
  #   #     2 4 6
  #
  # source://matrix//lib/matrix.rb#1524
  def t; end
  ...
  # @raise [ErrDimensionMismatch]
  #
  # source://matrix//lib/matrix.rb#1508
  def tr; end
...
class Matrix::EigenvalueDecomposition
  ...
  #
  # source://matrix//lib/matrix/eigenvalue_decomposition.rb#76
  def d; end
  ...
  #
  # source://matrix//lib/matrix/eigenvalue_decomposition.rb#83
  def to_a; end
  ...
  # Returns the eigenvector matrix +V+
  #
  # source://matrix//lib/matrix/eigenvalue_decomposition.rb#46
  def v; end

  # Returns the inverse of the eigenvector matrix +V+
  #
  # source://matrix//lib/matrix/eigenvalue_decomposition.rb#55
  def v_inv; end
...
class Vector
  ...
  # Returns element or elements of the vector.
  #
  # source://matrix//lib/matrix.rb#2038
  def component(i); end
  ...
  #
  # source://matrix//lib/matrix.rb#2346
  def cross(*vs); end
  ...
  # @raise [ErrDimensionMismatch]
  #
  # source://matrix//lib/matrix.rb#2312
  def dot(v); end
  ...
  # Returns element or elements of the vector.
  #
  # source://matrix//lib/matrix.rb#2037
  def element(i); end
  ...
  # Like Array#collect.
  #
  # source://matrix//lib/matrix.rb#2356
  def map(&block); end
  ...
  # @raise [FrozenError]
  #
  # source://matrix//lib/matrix.rb#2367
  def map!(&block); end
  ...
  #   Vector[5,8,2].r # => 9.643650761
  #
  # source://matrix//lib/matrix.rb#2377
  def norm; end
  ...
  #   Vector[5,8,2].r # => 9.643650761
  #
  # source://matrix//lib/matrix.rb#2376
  def r; end
  ...
  # @raise [FrozenError]
  #
  # source://matrix//lib/matrix.rb#2060
  ...
  # @raise [FrozenError]
  #
  # source://matrix//lib/matrix.rb#2059
  ...
  class << self
    ...
    # source://matrix//lib/matrix.rb#1973
    def new(*_arg0); end
  end
end
