...
module WebSocket
  class << self
    # source://websocket/1.2.10lib/websocket.rb#20
    def max_frame_size; end

    # source://websocket/1.2.10lib/websocket.rb#25
    def max_frame_size=(val); end

    # source://websocket/1.2.10lib/websocket.rb#31
    def should_raise; end

    # source://websocket/1.2.10lib/websocket.rb#36
