...
class Resque::Job
  ...
  class << self
    ...
    #
    # source://resque_spec/0.18.1/lib/resque_spec/ext.rb#10
    ...
    #
    # source://resque_spec/0.18.1/lib/resque_spec/ext.rb#18
...
class Resque::Server < ::Sinatra::Base
  ...
  class << self
    # source://sinatra/3.1.0/lib/sinatra/base.rb#1344
    def app_file; end

    # source://sinatra/3.1.0/lib/sinatra/base.rb#1343
...
class Resque::Worker
  ...
  #
  # source://resque-heroku-signals/2.6.0/lib/resque-heroku-signals.rb#17
  ...
  # source://resque-heroku-signals/2.6.0/lib/resque-heroku-signals.rb#42
