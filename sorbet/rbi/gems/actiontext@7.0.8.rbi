...
module ActionText
  ...
  class << self
    # source://railties/7.0.8lib/rails/engine.rb#405
    def railtie_helpers_paths; end

    # source://railties/7.0.8lib/rails/engine.rb#394
    def railtie_namespace; end

    # source://railties/7.0.8lib/rails/engine.rb#409
    def railtie_routes_url_helpers(include_path_helpers = T.unsafe(nil)); end

    # source://railties/7.0.8lib/rails/engine.rb#397
    def table_name_prefix; end

    # source://railties/7.0.8lib/rails/engine.rb#401
...
class ActionText::Attachables::ContentAttachment
  ...
  # source://activemodel/7.0.8lib/active_model/naming.rb#244
  ...
  # source://activemodel/7.0.8lib/active_model/validations.rb#48
...
class ActionText::Attachment
  ...
  # source://activesupport/7.0.8lib/active_support/core_ext/module/delegation.rb#302
  ...
  # source://activesupport/7.0.8lib/active_support/core_ext/module/delegation.rb#294
...
class ActionText::Content
  ...
  class << self
    ...
    # source://activesupport/7.0.8lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#48
    def renderer; end

    # source://activesupport/7.0.8lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#92
...
class ActionText::EncryptedRichText < ::ActionText::RichText
  ...
  class << self
    ...
    # source://activerecord/7.0.8lib/active_record/encryption/encryptable_record.rb#11
...
class ActionText::RichText < ::ActionText::Record
  ...
  class << self
    ...
    # source://activestorage/7.0.8lib/active_storage/reflection.rb#53
...
module ActionText::RichText::EmbedsAttachmentsAssociationExtension
  # source://activestorage/7.0.8lib/active_storage/attached/model.rb#165
  def purge; end

  # source://activestorage/7.0.8lib/active_storage/attached/model.rb#171
  def purge_later; end

  private

  # source://activestorage/7.0.8lib/active_storage/attached/model.rb#178
  def deprecate(action); end
end

module ActionText::RichText::GeneratedAssociationMethods
  # source://activestorage/7.0.8lib/active_storage/attached/model.rb#134
  def embeds; end

  # source://activestorage/7.0.8lib/active_storage/attached/model.rb#139
  def embeds=(attachables); end

  # source://activerecord/7.0.8lib/active_record/associations/builder/collection_association.rb#62
  def embeds_attachment_ids; end

  # source://activerecord/7.0.8lib/active_record/associations/builder/collection_association.rb#72
...
module ActionView::Helpers
  ...
  class << self
    # source://actionview/7.0.8lib/action_view/helpers.rb#34
    def eager_load!; end
  end
end

class ActionView::Helpers::FormBuilder
  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1701
  def initialize(object_name, object, template, options); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2615
  def button(value = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2439
  def check_box(method, options = T.unsafe(nil), checked_value = T.unsafe(nil), unchecked_value = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_options_helper.rb#907
  def collection_check_boxes(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_options_helper.rb#919
  def collection_radio_buttons(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_options_helper.rb#859
  def collection_select(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2007
  def color_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2007
  def date_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/date_helper.rb#1239
  ...
  # source://actionview/7.0.8lib/action_view/helpers/date_helper.rb#1263
  def datetime_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2007
  def email_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2636
  def emitted_hidden_id?; end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1666
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1758
  def field_id(method, *suffixes, namespace: T.unsafe(nil), index: T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1778
  def field_name(method, *methods, multiple: T.unsafe(nil), index: T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2295
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2258
  def fields_for(record_name, record_object = T.unsafe(nil), fields_options = T.unsafe(nil), &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2522
  def file_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_options_helper.rb#871
  def grouped_collection_select(method, collection, group_method, group_label_method, option_key_method, option_value_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2483
  def hidden_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1738
  def id; end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1678
  def index; end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2370
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1681
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1676
  def object; end
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2461
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_options_helper.rb#847
  def select(method, choices = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2554
  ...
  # source://actionview/7.0.8lib/action_view/helpers/date_helper.rb#1251
  def time_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_options_helper.rb#883
  def time_zone_select(method, priority_zones = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1697
  def to_model; end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1693
  def to_partial_path; end
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_options_helper.rb#895
  def weekday_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  private

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2721
  def convert_to_legacy_options(options); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2703
  def fields_for_nested_model(name, object, fields_options, block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2674
  def fields_for_with_nested_attributes(association_name, association, options, block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2670
  def nested_attributes_association?(association_name); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2716
  def nested_child_index(name); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2641
  def objectify_options(options); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#2647
  def submit_default_value; end

  class << self
    # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1689
...
module ActionView::Helpers::FormHelper
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1574
  def _object_for_form_builder(object); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1337
  def check_box(object_name, method, options = T.unsafe(nil), checked_value = T.unsafe(nil), unchecked_value = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1367
  def color_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1431
  def date_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1498
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1552
  def email_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1073
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1022
  def fields_for(record_name, record_object = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1239
  def file_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#433
  def form_for(record, options = T.unsafe(nil), &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#755
  def form_with(model: T.unsafe(nil), scope: T.unsafe(nil), url: T.unsafe(nil), format: T.unsafe(nil), **options, &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#480
  def form_with_generates_ids; end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#480
  def form_with_generates_ids=(val); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#478
  def form_with_generates_remote_forms; end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#478
  def form_with_generates_remote_forms=(val); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1206
  def hidden_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1143
  def label(object_name, method, content_or_options = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1517
  def month_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#482
  def multiple_file_field_include_hidden; end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#482
  def multiple_file_field_include_hidden=(val); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1561
  def number_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1188
  def password_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1399
  def phone_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1359
  def radio_button(object_name, method, tag_value, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1570
  def range_field(object_name, method, options = T.unsafe(nil)); end

  def rich_text_area(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1390
  def search_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1399
  def telephone_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1269
  def text_area(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1167
  def text_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1469
  def time_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1543
  def url_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1534
  def week_field(object_name, method, options = T.unsafe(nil)); end

  private

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#463
  def apply_form_for_options!(object, options); end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1608
  def default_form_builder_class; end

  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1579
  ...
  # source://actionview/7.0.8lib/action_view/helpers/form_helper.rb#1594
