...
module Haml::Util
  ...
  # in the cache.
  #
  # source://haml_lint//lib/haml_lint/extensions/haml_util_unescape_interpolation_tracking.rb#34
  ...
  # source://haml_lint//lib/haml_lint/extensions/haml_util_unescape_interpolation_tracking.rb#33
...
#
# source://haml_lint//lib/haml_lint/adapter/haml_5.rb#4
class HamlLint::Adapter
  class << self
    ...
    #
    # source://haml_lint//lib/haml_lint/adapter.rb#18
    ...
    #
    # source://haml_lint//lib/haml_lint/adapter.rb#32
...
#
# source://haml_lint//lib/haml_lint/adapter/haml_5.rb#7
...
# :reek:UncommunicativeModuleName
#
# source://haml_lint//lib/haml_lint/adapter/haml_6.rb#7
...
#
# source://haml_lint//lib/haml_lint/directive.rb#91
...
class HamlLint::Document
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#48
  ...
  # @param source [String] Haml code to parse
  #
  # source://haml_lint//lib/haml_lint/document.rb#73
  ...
  def file_on_disk; end

  # @return [String] the indentation used in the file
  #
  # source://haml_lint//lib/haml_lint/document.rb#36
  def indentation; end
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#60
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#33
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#38
  def unescape_interpolation_to_original_cache; end

  # source://haml_lint//lib/haml_lint/document.rb#90
  ...
  def write_to_stdout; end

  private

  # source://haml_lint//lib/haml_lint/document.rb#205
  ...
  #
  # source://haml_lint//lib/haml_lint/document.rb#158
  ...
  # @return [Haml::Tree::Node]
  #
  # source://haml_lint//lib/haml_lint/document.rb#139
  def process_tree(original_tree); end

  # Removes YAML frontmatter
  #
  # source://haml_lint//lib/haml_lint/document.rb#182
  def strip_frontmatter(source); end

  # source://haml_lint//lib/haml_lint/document.rb#212
...
class HamlLint::Linter::ClassesBeforeIds < ::HamlLint::Linter
  ...
  # source://haml_lint//lib/haml_lint/linter/classes_before_ids.rb#10
  def visit_tag(node); end

  private

  # source://haml_lint//lib/haml_lint/linter/classes_before_ids.rb#28
  ...
  # source://haml_lint//lib/haml_lint/linter/classes_before_ids.rb#44
  def ids_first?; end
end

# source://haml_lint//lib/haml_lint/linter/classes_before_ids.rb#8
...
class HamlLint::Linter::InstanceVariables < ::HamlLint::Linter
  ...
  # source://haml_lint//lib/haml_lint/linter/instance_variables.rb#52
  ...
  # source://haml_lint//lib/haml_lint/linter/instance_variables.rb#33
  def visit_silent_script(node); end
  ...
  # source://haml_lint//lib/haml_lint/linter/instance_variables.rb#71
  def enabled; end

  # source://haml_lint//lib/haml_lint/linter/instance_variables.rb#78
  def enabled?; end

  # source://haml_lint//lib/haml_lint/linter/instance_variables.rb#100
  def failure_message; end

  # source://haml_lint//lib/haml_lint/linter/instance_variables.rb#84
  def file_types; end

  # source://haml_lint//lib/haml_lint/linter/instance_variables.rb#92
  def matcher; end
end
...
class HamlLint::Linter::RuboCop < ::HamlLint::Linter
  ...
  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#74
  def last_extracted_source; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#74
  def last_extracted_source=(_arg0); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#75
  def last_new_ruby_source; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#75
  def last_new_ruby_source=(_arg0); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#77
  def visit_root(_node); end

  private

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#276
  ...
  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#385
  def marshal_load(ivars); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#180
  def new_haml_validity_checks(new_haml_string); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#228
  def process_ruby_source(ruby_code, source_map); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#306
  def record_lint(line, message, severity, corrected:); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#338
  def rubocop_autocorrect_flags; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#139
  def rubocop_config_for(path); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#217
  def rubocop_config_store; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#330
  def rubocop_options; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#213
  def rubocop_runner; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#244
  def run_rubocop(rubocop_runner, ruby_code, path); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#151
  def transfer_corrections(coordinator, new_ruby_code); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#147
  def transfer_corrections?(initial_ruby_code, new_ruby_code); end

  class << self
    # source://haml_lint//lib/haml_lint/linter/rubocop.rb#127
    def cops_names_not_supporting_autocorrect; end
  end
end

# source://haml_lint//lib/haml_lint/linter/rubocop.rb#317
HamlLint::Linter::RuboCop::DEFAULT_FLAGS = T.let(T.unsafe(nil), Array)

# source://haml_lint//lib/haml_lint/linter/rubocop.rb#20
class HamlLint::Linter::RuboCop::Runner < ::RuboCop::Runner
  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#49
  def cached_run?; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#31
  def corrected_code; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#40
  def file_finished(_file, offenses); end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#21
  def offenses; end

  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#23
  def run(haml_path, ruby_code, config:, allow_cache: T.unsafe(nil)); end
end
...
# source://haml_lint//lib/haml_lint/linter/strict_locals.rb#5
class HamlLint::Linter::StrictLocals < ::HamlLint::Linter
  include ::HamlLint::LinterRegistry

  # source://haml_lint//lib/haml_lint/linter/strict_locals.rb#14
  def visit_root(root); end

  private

  # source://haml_lint//lib/haml_lint/linter/strict_locals.rb#37
  def enabled?(root); end

  # source://haml_lint//lib/haml_lint/linter/strict_locals.rb#65
  def failure_message; end

  # source://haml_lint//lib/haml_lint/linter/strict_locals.rb#49
  def file_types; end

  # source://haml_lint//lib/haml_lint/linter/strict_locals.rb#57
  def matcher; end
end

# source://haml_lint//lib/haml_lint/linter/strict_locals.rb#8
class HamlLint::Linter::StrictLocals::DummyNode < ::Struct
  # source://haml_lint//lib/haml_lint/linter/strict_locals.rb#8
  def line; end
...
#
# source://haml_lint//lib/haml_lint/parsed_ruby.rb#7
class HamlLint::ParsedRuby < ::SimpleDelegator
  ...
  #
  # source://haml_lint//lib/haml_lint/parsed_ruby.rb#13
  def syntax_tree; end
end
...
# source://haml_lint//lib/haml_lint/reporter/github_reporter.rb#5
class HamlLint::Reporter::GithubReporter < ::HamlLint::Reporter
  include ::HamlLint::Reporter::Utils

  # source://haml_lint//lib/haml_lint/reporter/github_reporter.rb#10
  def added_lint(lint, report); end

  # source://haml_lint//lib/haml_lint/reporter/github_reporter.rb#18
  def display_report(report); end

  private

  # source://haml_lint//lib/haml_lint/reporter/github_reporter.rb#28
  def github_escape(string); end

  # source://haml_lint//lib/haml_lint/reporter/github_reporter.rb#24
  def print_workflow_command(lint:, severity: T.unsafe(nil)); end
end

# source://haml_lint//lib/haml_lint/reporter/github_reporter.rb#6
HamlLint::Reporter::GithubReporter::ESCAPE_MAP = T.let(T.unsafe(nil), Hash)

# source://haml_lint//lib/haml_lint/reporter/hash_reporter.rb#5
...
#
# source://haml_lint//lib/haml_lint/reporter/json_reporter.rb#7
...
#
# source://haml_lint//lib/haml_lint/reporter/progress_reporter.rb#10
class HamlLint::Reporter::ProgressReporter < ::HamlLint::Reporter
  include ::HamlLint::Reporter::Utils

  # source://haml_lint//lib/haml_lint/reporter/progress_reporter.rb#15
  def display_report(report); end

  # source://haml_lint//lib/haml_lint/reporter/progress_reporter.rb#24
  def finished_file(_file, lints); end

  # source://haml_lint//lib/haml_lint/reporter/progress_reporter.rb#28
  def start(files); end

  private

  # source://haml_lint//lib/haml_lint/reporter/progress_reporter.rb#34
  def dot; end

  # source://haml_lint//lib/haml_lint/reporter/progress_reporter.rb#38
  def report_file_as_mark(lints); end
end

# source://haml_lint//lib/haml_lint/reporter/progress_reporter.rb#13
...
#
# source://haml_lint//lib/haml_lint/linter/rubocop.rb#399
class HamlLint::RubocopConfigStore
  # @return [RubocopConfigStore] a new instance of RubocopConfigStore
  #
  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#400
  def initialize; end
  ...
  #
  # source://haml_lint//lib/haml_lint/linter/rubocop.rb#407
...
class HamlLint::RubyExtraction::ChunkExtractor
  ...
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#24
  ...
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#647
  def add_following_empty_lines(node, lines); end

  # Adds chunks for the interpolation within the given code
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#426
  def add_interpolation_chunks(node, code, haml_line_index, indent:, line_start_index: T.unsafe(nil)); end

  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#29
  def extract; end

  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#573
  ...
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#514
  ...
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#595
  ...
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#214
  ...
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#667
  def indent_after_line_index(line_index); end

  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#662
  def parse_ruby(source); end

  # Useful for tests
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#39
  def prepare_extract; end

  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#471
  def process_multiline!(line); end

  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#480
  ...
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#88
  def visit_comment(node); end

  # Visiting a HAML filter. Lines looking like `  :javascript` and the following lines
  # that are nested.
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#388
  def visit_filter(node); end

  # Visiting lines like `  -# Some commenting!`
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#55
  def visit_haml_comment(node); end

  # Visiting lines like `  Some raw text to output`
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#49
  def visit_plain(node); end

  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#44
  def visit_root(_node); end

  # Visit a script which outputs. Lines looking like `  = foo`
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#123
  def visit_script(node, &block); end

  # Visit a script which doesn't output. Lines looking like `  - foo`
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#195
  def visit_silent_script(node, &block); end

  # Visiting a tag. Lines looking like `  %div`
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#251
  def visit_tag(node); end
  ...
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#289
  ...
  #
  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#349
  def visit_tag_script(node, line_index:, indent:); end

  # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#637
  def wrap_lines(lines, wrap_depth); end

  class << self
    # @return [Boolean]
    #
    # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#679
    def anonymous_block?(code); end

    # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#693
    def block_keyword(code); end

    # @return [Boolean]
    #
    # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#688
    def start_block_keyword?(code); end

    # @return [Boolean]
    #
    # source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#675
...
#
# source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#22
HamlLint::RubyExtraction::ChunkExtractor::BLOCK_KEYWORD_REGEX = T.let(T.unsafe(nil), Regexp)
...
# source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#692
HamlLint::RubyExtraction::ChunkExtractor::LOOP_KEYWORDS = T.let(T.unsafe(nil), Array)

# source://haml_lint//lib/haml_lint/ruby_extraction/chunk_extractor.rb#687
...
#
# source://haml_lint//lib/haml_lint/runner.rb#9
class HamlLint::Runner
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#23
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#121
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#88
  def collect_lints(source, linter_selector, config); end
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#140
  def extract_applicable_sources(config, options); end

  # A flag for whether to fail after the first failure.
  #
  # @return [true, false]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#46
  def fail_fast; end
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#62
  ...
  # @return [HamlLint::Configuration]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#69
  ...
  # @return [void]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#170
  def process_source(source, report); end
  ...
  def process_sources(report); end
  ...
  #
  # source://haml_lint//lib/haml_lint/runner.rb#181
  ...
  # @return [void]
  #
  # source://haml_lint//lib/haml_lint/runner.rb#192
  def warm_cache; end
end
...
#
# source://haml_lint//lib/haml_lint/source.rb#6
class HamlLint::Source
  ...
  #
  # source://haml_lint//lib/haml_lint/source.rb#14
  def initialize(path: T.unsafe(nil), io: T.unsafe(nil)); end

  # @return [String] Contents of the given IO object.
  #
  # source://haml_lint//lib/haml_lint/source.rb#20
  def contents; end

  # @return [String] File path associated with the given IO object.
  #
  # source://haml_lint//lib/haml_lint/source.rb#8
  def path; end

  # @return [boolean] true if we're reading from stdin rather than a file path
  #
  # source://haml_lint//lib/haml_lint/source.rb#25
  def stdin?; end
end
...
#
# source://haml_lint//lib/haml_lint/tree/filter_node.rb#5
...
class HamlLint::Tree::HamlCommentNode < ::HamlLint::Tree::Node
  ...
  # @return [Boolean]
  #
  # source://haml_lint//lib/haml_lint/tree/haml_comment_node.rb#31
  def is_strict_locals?; end
  ...
  # source://haml_lint//lib/haml_lint/tree/haml_comment_node.rb#37
...
#
# source://haml_lint//lib/haml_lint/tree/node.rb#189
class HamlLint::Tree::Node::Siblings < ::SimpleDelegator
  ...
  # @return [Array<HamlLint::Tree::Node>]
  #
  # source://haml_lint//lib/haml_lint/tree/node.rb#233
  def siblings; end
...
#
# source://haml_lint//lib/haml_lint/tree/null_node.rb#5
...
#
# source://haml_lint//lib/haml_lint/tree/root_node.rb#7
...
#
# source://haml_lint//lib/haml_lint/tree/script_node.rb#7
...
#
# source://haml_lint//lib/haml_lint/tree/silent_script_node.rb#6
...
#
# source://haml_lint//lib/haml_lint/tree/tag_node.rb#5
...
module HamlLint::Utils
  ...
  # source://haml_lint//lib/haml_lint/utils.rb#252
  def regexp_for_parts(parts, join_regexp, prefix: T.unsafe(nil), suffix: T.unsafe(nil)); end
