...
#
# source://activejob/lib/active_job/queue_adapters/resque_adapter.rb#30
class ActiveJob::QueueAdapters::ResqueAdapter
  # source://activejob/lib/active_job/queue_adapters/resque_adapter.rb#31
  def enqueue(job); end

  # source://activejob/lib/active_job/queue_adapters/resque_adapter.rb#36
  def enqueue_at(job, timestamp); end
end

# source://activejob/lib/active_job/queue_adapters/resque_adapter.rb#44
class ActiveJob::QueueAdapters::ResqueAdapter::JobWrapper
  class << self
    # source://activejob/lib/active_job/queue_adapters/resque_adapter.rb#46
