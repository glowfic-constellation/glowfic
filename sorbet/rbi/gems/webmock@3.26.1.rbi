...
# source://webmock//lib/webmock/rspec.rb#7
...
module WebMock::Matchers
  # source://webmock//lib/webmock/rspec/matchers.rb#9
  def have_been_made; end

  # source://webmock//lib/webmock/rspec/matchers.rb#13
  def have_been_requested; end

  # source://webmock//lib/webmock/rspec/matchers.rb#17
  def have_not_been_made; end

  # source://webmock//lib/webmock/rspec/matchers.rb#25
  def have_not_requested(method, uri); end

  # source://webmock//lib/webmock/rspec/matchers.rb#21
...
# source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#4
class WebMock::RequestPatternMatcher
  # @return [RequestPatternMatcher] a new instance of RequestPatternMatcher
  #
  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#6
  def initialize; end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#25
  def at_least_once; end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#35
  def at_least_times(times); end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#30
  def at_least_twice; end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#40
  def at_most_once; end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#50
  def at_most_times(times); end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#45
  def at_most_twice; end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#73
  def description; end

  # @return [Boolean]
  #
  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#60
  def does_not_match?(request_pattern); end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#65
  def failure_message; end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#69
  def failure_message_when_negated; end

  # @return [Boolean]
  #
  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#55
  def matches?(request_pattern); end

  # RSpec 2 compatibility:
  #
  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#78
  def negative_failure_message; end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#10
  def once; end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#20
  def times(times); end

  # source://webmock//lib/webmock/rspec/matchers/request_pattern_matcher.rb#15
  def twice; end
end
...
# source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#4
class WebMock::WebMockMatcher
  # @return [WebMockMatcher] a new instance of WebMockMatcher
  #
  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#6
  def initialize(method, uri); end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#21
  def at_least_once; end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#31
  def at_least_times(times); end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#26
  def at_least_twice; end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#62
  def description; end

  # @return [Boolean]
  #
  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#50
  def does_not_match?(webmock); end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#54
  def failure_message; end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#58
  def failure_message_when_negated; end

  # @return [Boolean]
  #
  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#46
  def matches?(webmock); end

  # RSpec 2 compatibility:
  #
  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#67
  def negative_failure_message; end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#11
  def once; end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#41
  def times(times); end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#16
  def twice; end

  # source://webmock//lib/webmock/rspec/matchers/webmock_matcher.rb#36
  def with(options = T.unsafe(nil), &block); end
end
