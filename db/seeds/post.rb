Post.create!([
  ...
  },
  {
    ...
    section_order: 2,
    character_id: 31,
    content: "<p>Bella arrives early to her next gym class, too. Delaney's not there yet, which is annoying, because he knows how to solve a puzzle.<br /><br />Charlie knows a few things about Delaney and his family. The most interesting thing is this: Delaney appeared in the hospital with broken ribs, once. He did not do this crowing about how much fun it was to be stomped on/thrown down the stairs/whatever. He did this with no explanation at all. Charlie doesn't need victim cooperation to press charges for battery - but he does need someone to press charges against.<br /><br />And no one at school saw a thing.<br /><br />Audiences, indeed.</p>"
  },
  {
    board_id: 1,
    user_id: 3,
