...
# processes the Skylight Empire index
# https://github.com/sparklemotion/nokogiri/wiki/Cheat-sheet
response = HTTParty.get('http://glowfic.dreamwidth.org/27097.html')
html_doc = Nokogiri::HTML(response.body)
...
main_list.each do |section|
  ...
  section_index += 1
  next if section_index == 1 # I have been requested not to scrape Lost and Found
  ...
  links.each_with_index do |link, index|
    ...
    print " - " + title + "\n"
    next if Post.where(board_id: 11).where(subject: title).exists?
